...
scoresdf <- read_csv("C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\italian\\testDataItalian.csv")
...
write.csv(featuresdf,'C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\italian\\testplusliwc.csv',row.names=FALSE)
