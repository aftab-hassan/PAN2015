...
scoresdf <- read_csv("C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\spanish\\trainDataSpanish.csv")
...
df = read.csv('C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\spanish\\dataExtr1.csv')
...
write.csv(featuresdf,'C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\spanish\\trainplusliwc.csv',row.names=FALSE)
print("line 2")
