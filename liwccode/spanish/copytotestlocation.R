...
dfdataExtr1 = read.csv("C:\\Users\\arroju15\\pansubmission\\FinalCode\\IntermediatetestOutputSpanish\\dataExtr1.csv")
write.csv(dfdataExtr1,"C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\spanish\\testdataExtr1.csv",row.names=FALSE)
