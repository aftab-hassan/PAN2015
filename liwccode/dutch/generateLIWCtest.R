...
scoresdf <- read_csv("C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\dutch\\testDataDutch.csv")
...
write.csv(featuresdf,'C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\dutch\\testplusliwc.csv',row.names=FALSE)
