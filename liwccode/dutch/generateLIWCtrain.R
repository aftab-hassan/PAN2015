...
wordsandcategoriesdf <- read.table("C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\dutch\\inputfile", header=FALSE, sep = "|", quote = "")
...
scoresdf <- read_csv("C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\dutch\\trainDataDutch.csv")
...
df = read.csv('C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\dutch\\dataExtr1.csv')
...
write.csv(featuresdf,'C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\dutch\\trainplusliwc.csv',row.names=FALSE)
print("line 2")
...
# aftab@aftab-Inspiron-3542:~/Desktop/authorpan/dictionaryfiles$ wc -l LIWC2001_English.dic LIWC2007_Dutch.dic LIWC2001_Spanish.dic LIWC2007_dutch.dic
#   2389 LIWC2001_English.dic
#   6628 LIWC2007_Dutch.dic
#   7546 LIWC2001_Spanish.dic
#   5240 LIWC2007_dutch.dic
#  21803 total
