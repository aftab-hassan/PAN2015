...
#if test, then this file should have 0 against age_group,gender,extroverted,stable,agreeable,conscientious,open
scoresdf <- read_csv("C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\english\\testDataEnglish.csv")
...
for(user in 1:nrow(df))
{
	...
	#status,nTweets,age_group,gender,extroverted,stable,agreeable,conscientious,open
...
write.csv(featuresdf,'C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\english\\testplusliwc.csv',row.names=FALSE)
