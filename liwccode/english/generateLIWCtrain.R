...
wordsandcategoriesdf <- read.table("C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\english\\inputfile", header=FALSE, sep = "|", quote = "")
...
scoresdf <- read_csv("C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\english\\trainDataEnglish.csv")
...
df = read.csv('C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\english\\dataExtr1.csv')
...
for(user in 1:100)
{
	...
	for(i in 1:length(wordsforthisuser))
	{
		...
		#cat(paste("for",wordsforthisuser[i],"rownumberhavingword==",rownumberhavingword,"length(rownumberhavingword)==",length(rownumberhavingword),"\n"))
		...
		if(length(rownumberhavingword) == 1)
		{
			...
			if(length(lineofmatch) > 0)
			{
				...
				#cat(paste("came here1","lineofmatch==",lineofmatch))
				...
				#cat(paste("came here2","positions==",positions))
				...
				#cat(paste("came here3","tfidfvalue==",tfidfvalue))
	...
	featuresdf[user,"age"] = df[user,"age"]
	featuresdf[user,"gender"] = df[user,"gender"]
	featuresdf[user,"extS"] = df[user,"extS"]
	featuresdf[user,"neuS"] = df[user,"neuS"]
	featuresdf[user,"agrS"] = df[user,"agrS"]
	featuresdf[user,"consS"] = df[user,"consS"]
	featuresdf[user,"openS"] = df[user,"openS"]
}

featuresdf = featuresdf[which(complete.cases(featuresdf) == TRUE),]
print("line 1")
write.csv(featuresdf,'C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\english\\trainplusliwc.csv',row.names=FALSE)
print("line 2")
print(args[1])#"C:/Windows/Temp/arroju15/2015-05-09-23-33-45/output"
pathtocopy = paste0(args[1],"\\trainplusliwc.csv");
print(pathtocopy);
write.csv(featuresdf,pathtocopy,row.names=FALSE)
print("line 3")

testwritedf = read.csv("C:\\Users\\arroju15\\pansubmission\\FinalCode\\liwccode\\english\\trainplusliwc.csv")
print("line 4")
print("printing the trainplusliwc.csv from local")
print("line 5")
print(testwritedf[1,])
print("line 6")

#testwritedf = read.csv(pathtocopy);
print("line 7")
#print("printing the trainplusliwc.csv from tira")
#print(testwritedf[1,])
print("line 8")
...
# aftab@aftab-Inspiron-3542:~/Desktop/authorpan/dictionaryfiles$ wc -l LIWC2001_English.dic LIWC2007_Dutch.dic LIWC2001_Spanish.dic LIWC2007_english.dic
#   2389 LIWC2001_English.dic
#   6628 LIWC2007_Dutch.dic
#   7546 LIWC2001_Spanish.dic
#   5240 LIWC2007_english.dic
#  21803 total
